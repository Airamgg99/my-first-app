                    ...
                    <thead class="space-y-4">
                        @foreach ($workplaces as $workplace)
                            <tr class="bg-blue-200 flex flex-col wrap sm:table-row rounded-l-lg sm:rounded mb-4">
                                ...
                                <th class="h-16 p-3 text-center">Address</th>
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500">
                        Are you sure you want to delete the workplace {{ $selected_workplace->name ?? '' }}?
                    </h3>
